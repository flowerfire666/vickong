<template>
	<view :style="colorStyle">
		...
		<!-- 		<view class='loadingicon acea-row row-center-wrapper' v-if="cartList.valid.length&&!cartList.invalid.length">
			...
			<view class="tips acea-row row-middle" :class="newData.status && newData.status.status?'':'on'" v-if="isTips"><text class="iconfont icon-tishi"></text>部分活动不能叠加，系统已自动为您计算最优惠的价格</view>
