						...
						success() {
							switch (that.from) {
								case 'order_confirm':
									...
									if (that.id) {
										uni.navigateTo({
											url: `/pages/users/order_confirm/index${that.urlQuery}&invoice_id=${that.id}&invoice_name=${name}`
										})
									} else {
										uni.navigateTo({
											url: `/pages/users/order_confirm/index${that.urlQuery}&invoice_id=${res.data.id}&invoice_name=${name}`
										})
									}
									break;
								case 'order_details':
