	...
	<view>
		<view class="product-window"
			...
			<view class="joinBnt on"
				v-if="(iSbnt && attr.productSelect.quota<=0)||(iSbnt &&attr.productSelect.product_stock<=0)">已售罄
			</view>
			<view class="joinBnt bg-color" v-if="attr.productSelect.product_stock" @click="goCat">确定</view>
...
<script>
	export default {
		...
		methods: {
			...
			closeAttr: function() {
				if (this.attr.productSelect.product_stock > 0) {
					this.$emit('myevent');
				} else {
