...
class Routine {
	 ...
	 * 判断版本
	*/
   compareVersion(versionNow,versionBase){
	   var versionNowArray = versionNow.split(".");
	   var versionBaseArray = versionBase.split(".");
	   if(versionNowArray[1] >= versionBaseArray[1]){
		   if(versionNowArray[2] >= versionBaseArray[2]){
			   return 1;
		   }
		   else{
			   return -1;
