...
/**
 * 修改用户信息不同于上一条，这条主要是体温，真实姓名，手机号码的提交
 * @param object
 */
export function userEditreal(data) {
	return request.post('user/editreal', data);
}
...
export function getVipCard(data) {
	return request.post('user/vipcard',data);
}
 ...
 * @param object
*/
export function getAppointInfo() {
	return request.get('user/appoint');
}
 ...
 * @param object
 */
export function editAppointInfo(data) {
	return request.post('user/editappoint', data);
}