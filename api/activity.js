 ...
 * 获取vipcard订单详细信息
 */
export function vipcardOrderConfirm(data) {
	return request.post('vipcard/order/confirm', data);
}

/**
 * 获取积分订单创建
 */
export function vipcardOrderCreate(data) {
	return request.post('vipcard/order/create', data);
}