...
function GA4MPClient(apiSecret, measurementId, clientId) {
  ...
  this.GA_ENDPOINT = `https://www.vickong.cn/mp/collect?measurement_id=${this.MEASUREMENT_ID}&api_secret=${this.API_SECRET}`;
  this.DEBUG_ENDPOINT = `https://www.vickong.cn/debug/mp/collect?measurement_id=${this.MEASUREMENT_ID}&api_secret=${this.API_SECRET}`;
